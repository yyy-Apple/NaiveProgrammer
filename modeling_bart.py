...
class SelfAttention(nn.Module):
    ...
    def forward(
        ...
        if saved_state is not None:
            print(f'key_padding_mask.shape: {key_padding_mask.shape if key_padding_mask is not None else None}')
    ...
    def _cat_prev_key_padding_mask(
        ...
        if prev_key_padding_mask is not None:
            ...
            print(f'src_len - key_padding_mask.size(1): {src_len - key_padding_mask.size(1)}')
            filler = torch.zeros(
                batch_size,
